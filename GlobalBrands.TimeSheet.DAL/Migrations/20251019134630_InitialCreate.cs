        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Task_EndBeforeNow", "[EndDate] > GETDATE()");
                    table.CheckConstraint("CK_Task_StartBeforeEnd", "[StartDate] < [EndDate]");
                    table.CheckConstraint("CK_Task_StartBeforeNow", "[StartDate] >= GETDATE()");
                    table.ForeignKey(
